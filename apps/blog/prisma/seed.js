...
// tech seed
var techSeeder = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var admin, _i, techs_1, tech, res;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, userSeeder()];
        case 1:
          admin = _a.sent();
          (_i = 0), (techs_1 = techs);
          _a.label = 2;
          ...
          return [
            ...
            prisma.tech.upsert({
              ...
              update: {
                ...
                founders: {
                  connectOrCreate: tech.founder.map(function (founder) {
                    return {
                      where: {
                        name: founder.name,
                      },
                ...
                versions: {
                  connectOrCreate: tech.versions.map(function (version) {
                    return {
                      where: {
                        hash: version.hash,
                      },
            ...
            prisma.tag.upsert({
              ...
              update: {
                ...
                createBy: {
                  connect: {
                    email:
                      (u === null || u === void 0 ? void 0 : u.email) || "",
                  },
                },
              },
              create: {
...
var postSeeder = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    var techs, tags, posts, _i, posts_1, post, res;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, prisma.tech.findMany()];
        case 1:
          techs = _a.sent();
          ...
          return [
            ...
            prisma.post.create({
              data: {
                ...
                stack: {
                  connect: techs.map(function (tech) {
                    return {
                      id: tech.id,
                    };
                  }),
